...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Media_Playback.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Media_Playback.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Media', 'Windows.Devices.Enumeration', 'Windows.Media.Audio', 'Windows.Media.Protection', 'Windows.Media.Casting', 'Windows.UI.Composition', 'Windows.Graphics.DirectX.Direct3D11', 'Windows.Foundation', 'Windows.Storage', 'Windows.Storage.Streams', 'Windows.Media.Core', 'Windows.Media.MediaProperties'];
