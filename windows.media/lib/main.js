...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Media.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Media.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Graphics.Imaging', 'Windows.Graphics.DirectX.Direct3D11', 'Windows.Foundation', 'Windows.Graphics.DirectX', 'Windows.Storage.Streams', 'Windows.Storage', 'Windows.ApplicationModel.AppService'];
